 ...
 * 
 */
public class AppJdbcMysqlDaoImpl extends JdbcDaoSupport implements UserDetailsService {
	// ~ Static fields/initializers
	// =====================================================================================

	public static final String DEF_USERS_BY_USERNAME_QUERY = "select `usuarios`.usuario,`usuarios`.password from `usuarios` where `usuarios`.usuario = ?";
	public static final String DEF_AUTHORITIES_BY_USERNAME_DIRECT_QUERY = "select distinct `permiso`.nombre from `usuarios`, `perfil`, `perfilpermiso`, `permiso`, `usuariosperfil` where `perfil`.idperfil = `perfilpermiso`.idperfil and `permiso`.idpermiso = `perfilpermiso`.idpermiso and `usuarios`.idusuario = `usuariosperfil`.idusuario and `perfil`.idperfil = `usuariosperfil`.idperfil and `usuarios`.usuario = ?";
	public static final String DEF_AUTHORITIES_BY_USERNAME_LARGE_QUERY = "select distinct `permiso`.nombre from `usuarios`, `permiso`, `usuariospermiso` where `usuarios`.idusuario = `usuariospermiso`.idusuario and `permiso`.idpermiso = `usuariospermiso`.idpermiso and `usuarios`.usuario = ?";
	// ~ Instance fields
	// ================================================================================================
