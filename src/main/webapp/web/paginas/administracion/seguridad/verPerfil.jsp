...
<t:div styleClass="inferior separa_div_abajo">
	...
	<h:panelGrid columns="2" styleClass="tabla_layout w100" columnClasses="w50 separador_der, w50">
			<t:div>
				<h:panelGrid columns="2" styleClass="tabla_datos w100" columnClasses="header,null" rowClasses="null, alt" rendered="true">
					...
					<h:outputText value="#{mostrarPerfilManejado.perfil.nombre}" rendered="true" />
	...
	<h:form>
		<t:div styleClass="botones separa_div_arriba" style="width:100%">
			<a4j:commandButton actionListener="#{mostrarPerfilManejado.aceptar}" immediate="true" value="Aceptar" eventsQueue="ubig" requestDelay="3" />
			<a4j:commandButton actionListener="#{mostrarPerfilManejado.modificar}" rendered="true" immediate="true" value="Modificar" style="margin-left:10px" eventsQueue="ubig" requestDelay="3" />
