	...
	<t:div id="adicionarNomenclador" styleClass="w100">
		...
		<h:panelGrid columns="2" styleClass="tabla_layout w100" columnClasses="w50, separador_izq w50">			
			<t:div>				
				...
				<h:inputText id="value" value="#{modificarNomencladorManejado.nomenclador.value}" styleClass="required w100" />				
			</t:div>
			
			<t:div>
		  	    <h:outputLabel value="Tipo de Nomenclador" for="tipoNomenclador"/>
		  	    
				<h:selectOneMenu id="tipoNomenclador" value="#{modificarNomencladorManejado.nomenclador.keyWord}" styleClass="label w100">
		...
		<t:div styleClass="separador_arriba">
			<a4j:commandButton id="aceptar" value="Aceptar" actionListener="#{modificarNomencladorManejado.modificar}" disabled="false" reRender="formulario">
				<app:validationConfigurationGenerator id="validator" for="adicionarNomenclador"/>		
			</a4j:commandButton>
			
			<a4j:commandButton actionListener="#{modificarNomencladorManejado.cancelar}" immediate="true" value="Cancelar" style="margin-left:10px" eventsQueue="ubig" requestDelay="3" reRender="formulario"/>
		</t:div>
	</t:div>
</h:form>
